...
export class EmailService {
  ...
  constructor(apiKey: string) {
    this.apiKey = apiKey;
    console.log("EmailService initialized with API key:", apiKey ? "present" : "missing");
  }

  async sendNotifications(data: EmailData): Promise<{ success: boolean; error?: any }> {
    console.log("EmailService.sendNotifications called for:", data.email);
  ...
  async sendConfirmationToApplicant(data: EmailData): Promise<{ success: boolean; error?: any }> {
    try {
      const to = data.email;
  ...
  async sendNotificationToAdmin(data: EmailData): Promise<{ success: boolean; error?: any }> {
    try {
