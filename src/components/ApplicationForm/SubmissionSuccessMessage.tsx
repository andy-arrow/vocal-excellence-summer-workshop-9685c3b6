  ...
  return (
    ...
    >
      <div className="p-8 md:p-12 text-center">
        ...
        <motion.p
          className="mt-2 text-sm text-apple-grey italic max-w-xl mx-auto"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        >
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-apple-grey mt-1">
                We've sent a confirmation to your email with a copy of your application and the notification date.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              <h3 className="font-medium text-base text-apple-text">What happens next?</h3>
              <p className="text-sm text-apple-grey mt-1">
                {APPLY_SUCCESS_NEXT}
              </p>
            </div>
