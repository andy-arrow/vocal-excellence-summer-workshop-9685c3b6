    ...
    >
      <div className="w-full max-w-3xl">
            ...
            return (
              ...
              >
                <div className="flex flex-col items-center cursor-pointer">
                  <div className={`rounded-full transition-colors duration-300 flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 ${
                    isCompleted 
        ...
        <div className="md:hidden text-center mt-2">
          <span className="text-sm font-medium text-apple-text">{steps[currentStep]}</span>
        </div>
      </div>
    </motion.div>
  );
