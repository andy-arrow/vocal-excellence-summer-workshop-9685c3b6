      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="flex flex-col">
            ...
            <FormDescription className="text-sm text-muted-foreground mt-0.5 mb-1.5">
            ...
            <div className="flex gap-2">
              <Popover open={open} onOpenChange={setOpen}>
                <PopoverTrigger asChild>
                  <Button
                    ...
                    className="w-[100px] sm:w-[120px] justify-between px-2 sm:px-3 font-normal text-foreground"
                ...
                >
                  <Command>
                    ...
                    />
                    <CommandList className="max-h-[240px] sm:max-h-[280px]">
                      ...
                      <CommandGroup>
                        {sortedCountries.map((country) => (
                          <CommandItem
                            ...
                            className="flex items-center gap-2 py-2.5 sm:py-2 cursor-pointer text-base sm:text-sm"
                          >
                            <Check
                              className={cn(
                                "h-4 w-4 shrink-0",
                            ...
                            />
                            <span className="font-medium w-14 text-muted-foreground">
                              {country.dial}
                            </span>
              ...
              <FormControl>
                <Input 
                  ...
                  aria-required="true"
                  className="flex-1 text-foreground placeholder:text-muted-foreground text-base sm:text-sm"
