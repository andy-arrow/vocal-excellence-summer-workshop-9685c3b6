...
import { Calendar, Clock, Book, Mic, Users, Theater } from 'lucide-react';
...
const scheduleData = [
  ...
  { day: "Thursday", activities: ["Morning: Technique Workshop", "Afternoon: Individual Coaching", "Evening: Wellness Session"] },
