          ...
          <div className="md:col-span-2 space-y-8">
            <div className="prose prose-apple max-w-none space-y-6">
              ...
              <div className="space-y-6">
                <p className="text-[19px] leading-[1.4211] text-apple-text font-light">What makes us different? We believe preparation meets opportunity. Every participant receives a private lesson tailored just for you. You'll also work directly with an accompanist for 30 minutes on your repertoire. Our Alexander Technique workshops transform how you physically approach performance.</p>
