...
const AboutSection = () => {
  ...
  return (
    <section 
      id="about" 
      ref={sectionRef} 
      className="py-24 md:py-32 bg-[#fbfbfd] overflow-hidden"
    >
        ...
        <div className="grid md:grid-cols-5 gap-12 md:gap-16 items-start">
          <div className="md:col-span-2 space-y-8">
            <div className="prose prose-apple max-w-none space-y-6">
              <p className="text-[21px] leading-[1.381] font-light text-apple-text">
              ...
              <p className="text-[21px] font-medium text-apple-blue">
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center gap-6">
                  ...
                  <div className="flex-1">
                    ...
                    <a 
                      href="/apply" 
                      className="inline-flex items-center gap-2 px-6 py-3 bg-apple-blue text-white rounded-full text-[17px] font-medium 
