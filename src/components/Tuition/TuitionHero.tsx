    ...
    <section className={`${paddingClasses} px-4 bg-gradient-to-b from-white to-[#fafafa] relative z-10`}>
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-sm md:text-xl text-[#141414]/70 max-w-2xl mx-auto font-sans">
            Join our transformative program with options designed to support your musical journey
          </p>
          
          {/* Program dates with location */}
          <div className="inline-flex items-center gap-1 md:gap-2 text-[#141414]/60 text-xs md:text-sm font-medium mx-auto">
            <Calendar className="w-3 h-3 md:w-4 md:h-4 text-[#4f6e72]" />
            <span>14-18 July | Limassol, Cyprus</span>
          </div>
          
          <div className="pt-2 md:pt-3">
            <motion.div 
              className="h-1 w-12 md:w-16 bg-gradient-to-r from-[#4f6e72] to-[#6a8d91] rounded-full mx-auto"
              initial={{ width: 0 }}
