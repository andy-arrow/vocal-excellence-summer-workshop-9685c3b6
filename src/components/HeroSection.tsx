...
const HeroSection = () => {
  ...
  return (
    ...
    >
      {/* Hero Background */}
      <div className="absolute inset-0 bg-gradient-to-b from-rose-100/20 to-rose-50/10">
        {/* Using a solid background color with a gradient overlay instead of problematic image */}
