...
const HeroSection = () => {
  ...
  // Always use the uploaded image as background, no ambiguity.
  const imagePath = '/lovable-uploads/9b8804ac-a20d-45b0-a98d-48d6bef9154d.png';
  ...
  useEffect(() => {
    ...
    console.log('Attempting to load hero background image from:', imagePath);
  ...
  return (
    <section id="home" ref={heroRef} className="">
      ...
      />
      {/* Show fallback only if load fails (rare)—displays empty background */}
      {imageLoadError && (
